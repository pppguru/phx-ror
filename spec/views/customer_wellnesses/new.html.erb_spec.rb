...
RSpec.describe "customer_wellnesses/new", type: :view do
  before(:each) do
    assign(:customer_wellness, CustomerWellness.new(
      :company_id => 1,
      :pharmacy_id => 1,
      :customer_id => 1,
      :active => false,
  ...
  it "renders new customer_wellness form" do
    render

    assert_select "form[action=?][method=?]", customer_wellnesses_path, "post" do
